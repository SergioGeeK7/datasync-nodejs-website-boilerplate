...
export default class Stack {
  constructor(...stack_arguments) {
    ...
    case 1:
      if (typeof stack_arguments[0] === 'object' && typeof stack_arguments[0].api_key === 'string' && typeof stack_arguments[
          0].access_token === 'string' && typeof stack_arguments[0].environment === 'string') {
        this.headers = {
    ...
    case 3:
      if (typeof stack_arguments[0] === 'string' && typeof stack_arguments[1] === 'string' && typeof stack_arguments[
          2] === 'string') {
        this.headers = {
  ...
  getLastActivities() {
    let query = {
      ...
      url: this.config.protocol + '://' + this.config.host + ':' + this.config.port + '/' + this.config.version +
        this.config.urls.content_types,
      body: {
        _method: 'GET',
